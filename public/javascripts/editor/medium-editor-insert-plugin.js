    ...
    for (i = 0; i < this.elements.length; i += 1) {
      ...
      for (j = 0; j < $inserts.length; j++) {
        ...
        if ($insertData.length === 0) {
          ...
          if ($insert.hasClass('small-left')) {
            $insertData.addClass('small-left');
          }
          if ($insert.hasClass('small-right')) {
            $insertData.addClass('small-right');
          }
          if ($insert.hasClass('small-center')) {
            $insertData.addClass('small-center');
          }
  ...
  $.fn.mediumInsert.insert = {
    ...
    */
    ...
    setPlaceholders: function () {
      ...
      insertBlock += '</ul>';
      insertBlock = '<div class="mediumInsert small-center" contenteditable="false">'+
        '<div class="mediumInsert-buttons">'+
          '<a class="mediumInsert-buttonsShow"><i class="icons icons-add-further-reading"></i></a>'+
          insertBlock +
        '</div>'+
